...
export class WellnessInfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // MSK Cluster
    const kafkaCluster = new msk.CfnCluster(this, 'WellnessKafka', {
      clusterName: 'wellness-kafka',
      kafkaVersion: '3.4.0',
      numberOfBrokerNodes: 3,
      brokerNodeGroupInfo: {
        instanceType: 'kafka.t3.small',
        clientSubnets: ['subnet-12345678'], // Replace with your subnet ID
    ...
    fetchers.forEach(source => {
      lambdaFunctions[source] = new lambda.Function(this, `${source}Fetcher`, {
        ...
        environment: {
          KAFKA_BROKERS: kafkaCluster.ref,
