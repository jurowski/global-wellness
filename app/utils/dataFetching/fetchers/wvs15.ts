...
export class WVS15DataFetcher {
  private static instance: WVS15DataFetcher;
  private marker: DataSourceMarker;
  private readonly metrics = {
    'life_satisfaction': 'World Values Survey Wave 15',
    'happiness': 'World Values Survey Wave 15',
    'trust_in_people': 'World Values Survey Wave 15',
    'trust_in_police': 'World Values Survey Wave 15',
    'trust_in_politics': 'World Values Survey Wave 15',
    'trust_in_healthcare': 'World Values Survey Wave 15',
    'trust_in_education': 'World Values Survey Wave 15',
    'trust_in_technology': 'World Values Survey Wave 15',
    'social_trust': 'World Values Survey Wave 15',
    'political_trust': 'World Values Survey Wave 15',
    'institutional_trust': 'World Values Survey Wave 15',
    'social_connectedness': 'World Values Survey Wave 15',
    'digital_engagement': 'World Values Survey Wave 15',
    'environmental_concern': 'World Values Survey Wave 15',
    'climate_change_concern': 'World Values Survey Wave 15',
    'gender_equality': 'World Values Survey Wave 15',
    'work_life_balance': 'World Values Survey Wave 15',
    'political_engagement': 'World Values Survey Wave 15',
    'social_tolerance': 'World Values Survey Wave 15',
    'cultural_openness': 'World Values Survey Wave 15',
    'health_status': 'World Values Survey Wave 15',
    'subjective_wellbeing': 'World Values Survey Wave 15',
    'life_meaning': 'World Values Survey Wave 15',
    'economic_outlook': 'World Values Survey Wave 15',
    'social_mobility': 'World Values Survey Wave 15',
    'digital_trust': 'World Values Survey Wave 15',
    'mental_health': 'World Values Survey Wave 15',
    'social_support': 'World Values Survey Wave 15',
    'ai_trust': 'World Values Survey Wave 15',
    'future_optimism': 'World Values Survey Wave 15',
    'digital_literacy': 'World Values Survey Wave 15',
    'cybersecurity_awareness': 'World Values Survey Wave 15',
    'digital_wellbeing': 'World Values Survey Wave 15',
    'social_cohesion': 'World Values Survey Wave 15',
    'intergenerational_equity': 'World Values Survey Wave 15',
    'sustainable_consumption': 'World Values Survey Wave 15',
    'digital_resilience': 'World Values Survey Wave 15',
    'digital_inclusion': 'World Values Survey Wave 15',
    'social_innovation': 'World Values Survey Wave 15',
    'environmental_action': 'World Values Survey Wave 15',
    'digital_ethics': 'World Values Survey Wave 15',
    'global_citizenship': 'World Values Survey Wave 15',
    'cultural_heritage': 'World Values Survey Wave 15',
    'intercultural_understanding': 'World Values Survey Wave 15',
    'peace_attitudes': 'World Values Survey Wave 15',
    'conflict_resolution': 'World Values Survey Wave 15',
    'human_rights': 'World Values Survey Wave 15',
    'democratic_values': 'World Values Survey Wave 15',
    'global_cooperation': 'World Values Survey Wave 15',
    'sustainable_development': 'World Values Survey Wave 15',
    'future_generations': 'World Values Survey Wave 15',
    'digital_democracy': 'World Values Survey Wave 15',
    'social_resilience': 'World Values Survey Wave 15',
    'environmental_resilience': 'World Values Survey Wave 15',
    'digital_sustainability': 'World Values Survey Wave 15',
    'social_sustainability': 'World Values Survey Wave 15',
    'cultural_sustainability': 'World Values Survey Wave 15',
    'economic_sustainability': 'World Values Survey Wave 15',
    'political_sustainability': 'World Values Survey Wave 15',
    'environmental_sustainability': 'World Values Survey Wave 15',
    'quantum_awareness': 'World Values Survey Wave 15',
    'biotech_ethics': 'World Values Survey Wave 15',
    'space_exploration': 'World Values Survey Wave 15',
    'artificial_intelligence': 'World Values Survey Wave 15',
    'virtual_reality': 'World Values Survey Wave 15',
    'augmented_reality': 'World Values Survey Wave 15',
    'metaverse_engagement': 'World Values Survey Wave 15',
    'digital_identity': 'World Values Survey Wave 15',
    'cyber_security': 'World Values Survey Wave 15',
    'data_privacy': 'World Values Survey Wave 15',
    'digital_rights': 'World Values Survey Wave 15',
    'technological_optimism': 'World Values Survey Wave 15',
    'future_work': 'World Values Survey Wave 15',
    'digital_economy': 'World Values Survey Wave 15',
    'smart_cities': 'World Values Survey Wave 15',
    'digital_infrastructure': 'World Values Survey Wave 15',
    'technological_equity': 'World Values Survey Wave 15',
    'digital_governance': 'World Values Survey Wave 15',
    'technological_resilience': 'World Values Survey Wave 15',
    'digital_innovation': 'World Values Survey Wave 15',
    'technological_sustainability': 'World Values Survey Wave 15'
  };
  ...
  public static getInstance(): WVS15DataFetcher {
    if (!WVS15DataFetcher.instance) {
      WVS15DataFetcher.instance = new WVS15DataFetcher();
    }
    return WVS15DataFetcher.instance;
  }
    ...
    countries.forEach(country => {
      Object.entries(this.metrics).forEach(([metric, source]) => {
        mockData[`${country}_${metric}`] = {
          ...
          validity: this.marker.markData('WVS15', year, 0),
