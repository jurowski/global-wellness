...
export class WVS12DataFetcher {
  private static instance: WVS12DataFetcher;
  private marker: DataSourceMarker;
  private readonly metrics = {
    'life_satisfaction': 'World Values Survey Wave 12',
    'happiness': 'World Values Survey Wave 12',
    'trust_in_people': 'World Values Survey Wave 12',
    'trust_in_police': 'World Values Survey Wave 12',
    'trust_in_politics': 'World Values Survey Wave 12',
    'trust_in_healthcare': 'World Values Survey Wave 12',
    'trust_in_education': 'World Values Survey Wave 12',
    'trust_in_technology': 'World Values Survey Wave 12',
    'social_trust': 'World Values Survey Wave 12',
    'political_trust': 'World Values Survey Wave 12',
    'institutional_trust': 'World Values Survey Wave 12',
    'social_connectedness': 'World Values Survey Wave 12',
    'digital_engagement': 'World Values Survey Wave 12',
    'environmental_concern': 'World Values Survey Wave 12',
    'climate_change_concern': 'World Values Survey Wave 12',
    'gender_equality': 'World Values Survey Wave 12',
    'work_life_balance': 'World Values Survey Wave 12',
    'political_engagement': 'World Values Survey Wave 12',
    'social_tolerance': 'World Values Survey Wave 12',
    'cultural_openness': 'World Values Survey Wave 12',
    'health_status': 'World Values Survey Wave 12',
    'subjective_wellbeing': 'World Values Survey Wave 12',
    'life_meaning': 'World Values Survey Wave 12',
    'economic_outlook': 'World Values Survey Wave 12',
    'social_mobility': 'World Values Survey Wave 12',
    'digital_trust': 'World Values Survey Wave 12',
    'mental_health': 'World Values Survey Wave 12',
    'social_support': 'World Values Survey Wave 12',
    'ai_trust': 'World Values Survey Wave 12',
    'future_optimism': 'World Values Survey Wave 12',
    'digital_literacy': 'World Values Survey Wave 12',
    'cybersecurity_awareness': 'World Values Survey Wave 12',
    'digital_wellbeing': 'World Values Survey Wave 12',
    'social_cohesion': 'World Values Survey Wave 12',
    'intergenerational_equity': 'World Values Survey Wave 12',
    'sustainable_consumption': 'World Values Survey Wave 12',
    'digital_resilience': 'World Values Survey Wave 12',
    'digital_inclusion': 'World Values Survey Wave 12',
    'social_innovation': 'World Values Survey Wave 12',
    'environmental_action': 'World Values Survey Wave 12',
    'digital_ethics': 'World Values Survey Wave 12',
    'global_citizenship': 'World Values Survey Wave 12',
    'cultural_heritage': 'World Values Survey Wave 12',
    'intercultural_understanding': 'World Values Survey Wave 12',
    'peace_attitudes': 'World Values Survey Wave 12',
    'conflict_resolution': 'World Values Survey Wave 12',
    'human_rights': 'World Values Survey Wave 12',
    'democratic_values': 'World Values Survey Wave 12',
    'global_cooperation': 'World Values Survey Wave 12',
    'sustainable_development': 'World Values Survey Wave 12',
    'future_generations': 'World Values Survey Wave 12'
  };
  ...
  public static getInstance(): WVS12DataFetcher {
    if (!WVS12DataFetcher.instance) {
      WVS12DataFetcher.instance = new WVS12DataFetcher();
    }
    return WVS12DataFetcher.instance;
  }
    ...
    countries.forEach(country => {
      Object.entries(this.metrics).forEach(([metric, source]) => {
        mockData[`${country}_${metric}`] = {
          ...
          validity: this.marker.markData('WVS12', year, 0),
